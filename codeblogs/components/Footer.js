      ...
      <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
        <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
          <a className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
            <Image src="/logo.png" height={40} width={48} />
            <span className="ml-3 text-xl">Codeblogs</span>
          </a>
        ...
        <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
          ...
          <div className="lg:w-1/3 md:w-1/2 w-full px-4">
            <h2 className="title-font font-semibold text-gray-900 tracking-widest text-sm mb-3 px-2 text-left">Services</h2>
            <nav className="list-none mb-10">
              <a href='https://react-icons.github.io/react-icons/search?q=email' target={'_blank'} className="flex items-center space-x-2 hover:bg-purple-500 w-fit px-2 py-1 rounded-md"> Advertisements</a>
              <a href='https://react-icons.github.io/react-icons/search?q=email' target={'_blank'} className="flex items-center space-x-2 hover:bg-purple-500 w-fit px-2 py-1 rounded-md"> Get Your Own website </a>
              {/* <a href='https://react-icons.github.io/react-icons/search?q=email' target={'_blank'} className="flex items-center space-x-"> Get Your Own website </a> */}
            </nav>
          </div>
          <div className="lg:w-1/3 md:w-1/2 w-full px-4">
            <h2 className="title-font font-semibold text-gray-900 tracking-widest text-sm mb-3 px-2 text-left">About US</h2>
            <nav className="mb-10">
              <p className='w-fit px-2 py-1'>
                we were created to facilitate options to coder 
              </p>
              <a href='/Aboutus' target={'_blank'} className="flex items-center space-x-2 hover:bg-purple-500 w-fit px-2 py-1 rounded-md">ReadMore</a>
            </nav>
          </div>
