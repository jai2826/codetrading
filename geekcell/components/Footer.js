    ...
    <footer className="">
      <div className="justify-between py-2 px-4 border-gray-100 border-2 mx-auto flex items-center sm:flex-row flex-col">
        <div className="flex items-center flex-col md:flex-row">
          <span className="flex font-medium items-center  justify-center text-gray-900">
            <Link href={'/'}>
              <Image className="rounded-md " src="/icons/Geeklogo5.png" alt="Geekcell.in " width="60" height="60" />
            </Link>
            <Link href={'/'}>
