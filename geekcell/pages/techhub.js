...
const page = ({ blogs }) => {
  ...
  return (
    <>
      <Head>
        <title>Techhub - Get to know about every technology</title>
...
export async function getServerSideProps(context) {
  ...
  let a = await fetch(`${process.env.NEXT_PUBLIC_STRAPI_URL}/api/blogs?filters[categories][name]=Tech&sort=updatedAt%3Adesc&populate=*`, { headers: headers })
