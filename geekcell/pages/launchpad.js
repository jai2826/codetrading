  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Get to know about the new tech just launchpad" />
...
export async function getServerSideProps(context) {
  ...
  let a = await fetch(`${process.env.NEXT_PUBLIC_STRAPI_URL}/api/blogs?filters[categories][name]=Launchpad&sort=updatedAt%3Adesc&populate=*`, { headers: headers })
