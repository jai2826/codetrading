...
async function getServerSideProps(context) {
    ...
    let a = await fetch(`${"http://localhost:1337"}/api/blogs?filters[categories][name]=Technews&sort=updatedAt%3Adesc&populate=*`, {
        headers: headers
    });
...
var __webpack_exports__ = __webpack_require__.X(0, [895,664,675,819], () => (__webpack_exec__(607)));
